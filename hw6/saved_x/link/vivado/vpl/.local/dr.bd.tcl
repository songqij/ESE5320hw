...
#---------------------------
# Instantiating axi_ic_zynq_ultra_ps_e_0_S_AXI_HP1_FPD
#---------------------------
...
set_property -dict [ list  \
  ...
  CONFIG.NUM_SI {1} \
  CONFIG.M00_HAS_REGSLICE {0} \
  CONFIG.S00_HAS_REGSLICE {0}  ] $axi_ic_zynq_ultra_ps_e_0_S_AXI_HP1_FPD

#---------------------------
# Instantiating axi_ic_zynq_ultra_ps_e_0_S_AXI_HP2_FPD
#---------------------------
...
set_property -dict [ list  \
  ...
  CONFIG.NUM_SI {1} \
  CONFIG.M00_HAS_REGSLICE {0} \
  CONFIG.S00_HAS_REGSLICE {0}  ] $axi_ic_zynq_ultra_ps_e_0_S_AXI_HP2_FPD
...
connect_bd_intf_net \
  [get_bd_intf_pins -auto_enable /axi_ic_zynq_ultra_ps_e_0_S_AXI_HP1_FPD/M00_AXI] \
  [get_bd_intf_pins -auto_enable /zynq_ultra_ps_e_0/S_AXI_HP1_FPD] \

connect_bd_intf_net \
  [get_bd_intf_pins -auto_enable /axi_ic_zynq_ultra_ps_e_0_S_AXI_HP2_FPD/M00_AXI] \
  [get_bd_intf_pins -auto_enable /zynq_ultra_ps_e_0/S_AXI_HP2_FPD] \

connect_bd_intf_net \
  [get_bd_intf_pins -auto_enable /axi_ic_zynq_ultra_ps_e_0_M_AXI_HPM1_FPD/M00_AXI] \
  [get_bd_intf_pins -auto_enable /mmult_fpga_1/s_axi_control] \

connect_bd_intf_net \
  [get_bd_intf_pins -auto_enable /mmult_fpga_1/m_axi_b0] \
  [get_bd_intf_pins -auto_enable /axi_ic_zynq_ultra_ps_e_0_S_AXI_HP0_FPD/S00_AXI] \

connect_bd_intf_net \
  [get_bd_intf_pins -auto_enable /mmult_fpga_1/m_axi_b1] \
  [get_bd_intf_pins -auto_enable /axi_ic_zynq_ultra_ps_e_0_S_AXI_HP1_FPD/S00_AXI] \

connect_bd_intf_net \
  [get_bd_intf_pins -auto_enable /mmult_fpga_1/m_axi_b2] \
  [get_bd_intf_pins -auto_enable /axi_ic_zynq_ultra_ps_e_0_S_AXI_HP2_FPD/S00_AXI] \
...
connect_bd_net  \
  ...
  [get_bd_pins -auto_enable /zynq_ultra_ps_e_0/saxihp1_fpd_aclk] \
  [get_bd_pins -auto_enable /zynq_ultra_ps_e_0/saxihp2_fpd_aclk] \
  [get_bd_pins -auto_enable /mmult_fpga_1/ap_clk] \
  ...
  [get_bd_pins -auto_enable /axi_ic_zynq_ultra_ps_e_0_S_AXI_HP1_FPD/S00_ACLK] \
  [get_bd_pins -auto_enable /axi_ic_zynq_ultra_ps_e_0_S_AXI_HP2_FPD/S00_ACLK] \
  ...
  [get_bd_pins -auto_enable /axi_ic_zynq_ultra_ps_e_0_S_AXI_HP1_FPD/ACLK] \
  [get_bd_pins -auto_enable /axi_ic_zynq_ultra_ps_e_0_S_AXI_HP1_FPD/M00_ACLK] \
  [get_bd_pins -auto_enable /axi_ic_zynq_ultra_ps_e_0_S_AXI_HP2_FPD/ACLK] \
  [get_bd_pins -auto_enable /axi_ic_zynq_ultra_ps_e_0_S_AXI_HP2_FPD/M00_ACLK] \
...
connect_bd_net  \
  ...
  [get_bd_pins -auto_enable /axi_ic_zynq_ultra_ps_e_0_S_AXI_HP1_FPD/ARESETN] \
  [get_bd_pins -auto_enable /axi_ic_zynq_ultra_ps_e_0_S_AXI_HP1_FPD/M00_ARESETN] \
  [get_bd_pins -auto_enable /axi_ic_zynq_ultra_ps_e_0_S_AXI_HP1_FPD/S00_ARESETN] \
  [get_bd_pins -auto_enable /axi_ic_zynq_ultra_ps_e_0_S_AXI_HP2_FPD/ARESETN] \
  [get_bd_pins -auto_enable /axi_ic_zynq_ultra_ps_e_0_S_AXI_HP2_FPD/M00_ARESETN] \
  [get_bd_pins -auto_enable /axi_ic_zynq_ultra_ps_e_0_S_AXI_HP2_FPD/S00_ARESETN] \

connect_bd_net  \
  [get_bd_pins -auto_enable /proc_sys_reset_0/peripheral_aresetn] \
  [get_bd_pins -auto_enable /mmult_fpga_1/ap_rst_n] \
...
connect_bd_net  \
  [get_bd_pins -auto_enable /mmult_fpga_1/interrupt] \
