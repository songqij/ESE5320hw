...
if { ![report_timing_and_scale_freq "" "dr" "../../../output" "/mnt/castor/seas_home/s/songqij/ese532_code/hw6/apps/mmult/_x/link/int" "kernel_clock_freqs {} system_clock_freqs {} worst_negative_slack 0 max_frequency 650 min_frequency 10 error_on_hold_violation true skip_timing_and_scaling false enable_auto_freq_scale false" "kernel"] } {
  return false
}
