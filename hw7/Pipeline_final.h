...
void Filter_horizontal_HW(hls::stream<unsigned char>&Input_temp, hls::stream<unsigned char>&Output_temp);
void Filter_vertical_HW(hls::stream<unsigned char> & Input_temp, hls::stream<unsigned char>&result);
