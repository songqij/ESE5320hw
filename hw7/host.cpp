...
//     cl::CommandQueue q1(context, device, CL_QUEUE_PROFILING_ENABLE|CL_QUEUE_OUT_OF_ORDER_EXEC_MODE_ENABLE, &err);
//     cl::CommandQueue q2(context, device, CL_QUEUE_PROFILING_ENABLE|CL_QUEUE_OUT_OF_ORDER_EXEC_MODE_ENABLE, &err);
//     cl::CommandQueue q3(context, device, CL_QUEUE_PROFILING_ENABLE|CL_QUEUE_OUT_OF_ORDER_EXEC_MODE_ENABLE, &err);
...
//     unsigned char *Scale_Output = (unsigned char *)malloc(FRAMES * INPUT_FRAME_SIZE);
//     unsigned char *Differentiate_Input = (unsigned char *)malloc(FRAMES * OUTPUT_FRAME_SIZE);
...
//     //     Scale_SW(Scale_Input + i * INPUT_FRAME_SIZE,Scale_Output + i * INPUT_FRAME_SIZE);
...
//         std::memcpy(Filter_Input[i % NUM_MAT], Scale_Output + i * INPUT_FRAME_SIZE, Input_bytes_per_iteration);
//         std::memcpy(Filter_Input[(i + 1) % NUM_MAT], Scale_Output + (i + 1) * INPUT_FRAME_SIZE, Input_bytes_per_iteration);
//         std::memcpy(Filter_Input[(i + 2) % NUM_MAT], Scale_Output + (i + 2) * INPUT_FRAME_SIZE, Input_bytes_per_iteration);
//         std::memcpy(Filter_Input[(i + 3) % NUM_MAT], Scale_Output + (i + 3) * INPUT_FRAME_SIZE, Input_bytes_per_iteration);
...
//             //std::memcpy(Differentiate_Input + i * OUTPUT_FRAME_SIZE, Filter_Output[i % NUM_MAT], Output_bytes_per_iteration);
//         }
//         // r[i].wait();
...
//             //std::memcpy(Differentiate_Input + (i + 1) * OUTPUT_FRAME_SIZE, Filter_Output[(i + 1) % NUM_MAT], Output_bytes_per_iteration);
//         }
//         // r[i+1].wait();
...
//             //std::memcpy(Differentiate_Input + (i + 2) * OUTPUT_FRAME_SIZE, Filter_Output[(i + 2) % NUM_MAT], Output_bytes_per_iteration);
//         }
//         // r[i+2].wait();
...
//         //     //std::memcpy(Differentiate_Input + (i + 3) * OUTPUT_FRAME_SIZE, Filter_Output[(i + 3) % NUM_MAT], Output_bytes_per_iteration);
//         // }
//         r[i+3].wait();
//         std::memcpy(Differentiate_Input + i * OUTPUT_FRAME_SIZE, Filter_Output[i % NUM_MAT], Output_bytes_per_iteration);
//         std::memcpy(Differentiate_Input + (i + 1) * OUTPUT_FRAME_SIZE, Filter_Output[(i + 1) % NUM_MAT], Output_bytes_per_iteration);
...
//     timer2.add("Differentiate");

//     int num_threads = std::thread::hardware_concurrency(); 
//     int frames_per_thread = FRAMES / num_threads;          
//     int remaining_frames = FRAMES % num_threads;          



//     for (int t = 0; t < num_threads; ++t) {
//         int start_frame = t * frames_per_thread;
//         int end_frame = start_frame + frames_per_thread;
...
//         threads.emplace_back([&, start_frame, end_frame]() {
//             for (int i = start_frame; i < end_frame; i++) {
            
//                 Differentiate_SW(Differentiate_Input + i * OUTPUT_FRAME_SIZE, Differentiate_Output + i * OUTPUT_FRAME_SIZE);
//             }
//         });
// }
...
//     //     // Compress 操作，将 Differentiate_Output 转换为 Compress_Output

//     //     Result_size = Compress_SW(Differentiate_Output + i * OUTPUT_FRAME_SIZE, Compress_Output);
//     //     //printf("D_success%d\n",i);
//     //     //printf("The %d frame Size is=%d\n",i,Result_size);   
//     // }
...
//     // ------------------------------------------------------------------------------------
//     printf("Result-size is %d",Result_size);
