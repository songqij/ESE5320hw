...
__attribute__((sdx_kernel("Filter_horizontal_HW", 0))) void Filter_horizontal_HW(const unsigned char * Input,unsigned char * Output);
...
{
  int X, Y, i;
  VITIS_LOOP_22_1: for (Y = 0; Y < ((540) / 2); Y++)
    VITIS_LOOP_23_2: for (X = 0; X < (((960) / 2) - ((7) - 1)); X++)
    {
      unsigned int Sum = 0;
      VITIS_LOOP_26_3: for (i = 0; i < (7); i++)
...
__attribute__((sdx_kernel("Filter_horizontal_HW", 0))) void Filter_horizontal_HW(const unsigned char * Input, unsigned char * Output)
{
#pragma HLS TOP name=Filter_horizontal_HW
# 33 "Filter.cpp"
...
#pragma HLS ARRAY_PARTITION variable=Input_buffer complete
 ...
 VITIS_LOOP_48_1: for (int i=0;i<7;i++)
    {
     Coefficient_buffer[i] = Coefficients[i];
    }

    VITIS_LOOP_53_2: for (Y = 0; Y < ((540) / 2); Y++) {

     VITIS_LOOP_55_3: for (i = 1; i < (7); i++)
     {
      Input_buffer[i] = Input[(Y * ((960) / 2)) + i - 1];
     }

        VITIS_LOOP_60_4: for (X = 0; X < (((960) / 2) - ((7) - 1)); X++) {
# 69 "Filter.cpp"
         VITIS_LOOP_69_5: for (i = 0; i < (7) - 1; i++)
         {
...
{
  int X, Y, i;
  VITIS_LOOP_88_1: for (Y = 0; Y < (((540) / 2) - ((7) - 1)); Y++)
    VITIS_LOOP_89_2: for (X = 0; X < (((960) / 2) - ((7) - 1)); X++)
    {
      unsigned int Sum = 0;
      VITIS_LOOP_92_3: for (i = 0; i < (7); i++)
