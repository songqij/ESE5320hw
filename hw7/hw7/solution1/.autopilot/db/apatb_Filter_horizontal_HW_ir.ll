; ModuleID = '/mnt/castor/seas_home/s/songqij/ese532_code/hw7/hw7/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: noinline
define void @apatb_Filter_horizontal_HW_ir(i8* %Input, i8* %Output) local_unnamed_addr #0 {
entry:
  %Input_copy = alloca i8, align 512
  %Output_copy = alloca i8, align 512
  call fastcc void @copy_in(i8* %Input, i8* nonnull align 512 %Input_copy, i8* %Output, i8* nonnull align 512 %Output_copy)
  call void @apatb_Filter_horizontal_HW_hw(i8* %Input_copy, i8* %Output_copy)
  call fastcc void @copy_out(i8* %Input, i8* nonnull align 512 %Input_copy, i8* %Output, i8* nonnull align 512 %Output_copy)
  ret void
}
...
declare void @apatb_Filter_horizontal_HW_hw(i8*, i8*)

define void @Filter_horizontal_HW_hw_stub_wrapper(i8*, i8*) #5 {
entry:
  call void @copy_out(i8* null, i8* %0, i8* null, i8* %1)
  call void @Filter_horizontal_HW_hw_stub(i8* %0, i8* %1)
  call void @copy_in(i8* null, i8* %0, i8* null, i8* %1)
  ret void
}

declare void @Filter_horizontal_HW_hw_stub(i8*, i8*)
