...
extern "C" void Filter_vertical_HW(char*, int, int);
extern "C" void apatb_Filter_vertical_HW_hw(volatile void * __xlx_apatb_param_Input, volatile void * __xlx_apatb_param_Output) {
  ...
  vector<sc_bv<8> >__xlx_Input_Output__tmp_vec;
  for (int j = 0, e = 1; j != e; ++j) {
    __xlx_Input_Output__tmp_vec.push_back(((char*)__xlx_apatb_param_Input)[j]);
  }
  int __xlx_size_param_Input = 1;
  int __xlx_offset_param_Input = 0;
  int __xlx_offset_byte_param_Input = 0*1;
  for (int j = 0, e = 1; j != e; ++j) {
    __xlx_Input_Output__tmp_vec.push_back(((char*)__xlx_apatb_param_Output)[j]);
  }
  int __xlx_size_param_Output = 1;
  int __xlx_offset_param_Output = 1;
  int __xlx_offset_byte_param_Output = 1*1;
  char* __xlx_Input_Output__input_buffer= new char[__xlx_Input_Output__tmp_vec.size()];
  for (int i = 0; i < __xlx_Input_Output__tmp_vec.size(); ++i) {
    __xlx_Input_Output__input_buffer[i] = __xlx_Input_Output__tmp_vec[i].range(7, 0).to_uint64();
  }
  // DUT call
  Filter_vertical_HW(__xlx_Input_Output__input_buffer, __xlx_offset_byte_param_Input, __xlx_offset_byte_param_Output);
