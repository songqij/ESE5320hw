...
// wrapc file define:
#define AUTOTB_TVIN_aximm1 "../tv/cdatafile/c.Filter_HW.autotvin_aximm1.dat"
#define AUTOTB_TVOUT_aximm1 "../tv/cdatafile/c.Filter_HW.autotvout_aximm1.dat"
// wrapc file define:
#define AUTOTB_TVIN_aximm2 "../tv/cdatafile/c.Filter_HW.autotvin_aximm2.dat"
#define AUTOTB_TVOUT_aximm2 "../tv/cdatafile/c.Filter_HW.autotvout_aximm2.dat"
// wrapc file define:
...
// tvout file define:
#define AUTOTB_TVOUT_PC_aximm1 "../tv/rtldatafile/rtl.Filter_HW.autotvout_aximm1.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_aximm2 "../tv/rtldatafile/rtl.Filter_HW.autotvout_aximm2.dat"
// tvout file define:
    ...
    string AESL_num;{
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<128> > aximm2_pc_buffer(1);
          int i = 0;
          ...
          if (i > 0) {{
            int i = 0;
            for (int j = 0, e = 1; j < e; j += 1, ++i) {((long long*)__xlx_apatb_param_Output)[j*2+0] = aximm2_pc_buffer[i].range(63,0).to_int64();
((long long*)__xlx_apatb_param_Output)[j*2+1] = aximm2_pc_buffer[i].range(127,64).to_int64();
}}}
        } // end transaction
      } // end file is good
