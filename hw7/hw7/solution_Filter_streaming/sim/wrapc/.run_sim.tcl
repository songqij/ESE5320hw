...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "Filter_HW.autotvin.dat"
	set constFileTvOut       "Filter_HW.autotvout.dat"
	set constFileHdlTvIn     "Filter_HW.autohdltvin.dat"
	set constFileHdlTvOut    "Filter_HW.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
