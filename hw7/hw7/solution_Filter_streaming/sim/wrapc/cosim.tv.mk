...
$(ObjDir)/testbench_streaming.cpp_pre.cpp.tb.o : testbench_streaming.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling testbench_streaming.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/Compress.cpp_pre.cpp.tb.o : Compress.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling Compress.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
...
$(ObjDir)/Filter_final.cpp_pre.cpp.tb.o : Filter_final.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling Filter_final.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/Scale.cpp_pre.cpp.tb.o : Scale.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling Scale.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
