...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_chunk_size \
    op interface \
    ports { chunk_size { I 64 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { compressed_data { I 64 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { compressed_size { I 64 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 6 \
    name gmem_load_out_out \
    type fifo \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_gmem_load_out_out \
    op interface \
    ports { gmem_load_out_out_din { O 32 vector } gmem_load_out_out_full_n { I 1 bit } gmem_load_out_out_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 8 \
    name compressed_data_out \
    type fifo \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_compressed_data_out \
    op interface \
    ports { compressed_data_out_din { O 64 vector } compressed_data_out_full_n { I 1 bit } compressed_data_out_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 9 \
    name compressed_size_out \
    type fifo \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_compressed_size_out \
    op interface \
    ports { compressed_size_out_din { O 64 vector } compressed_size_out_full_n { I 1 bit } compressed_size_out_write { O 1 bit } } \
} "
}
