set moduleName Block_split1_proc9
set isTopModule 0
...
set C_modelName {Block_.split1_proc9}
set C_modelType { void 0 }
set C_modelArgList {
	{ chunk_size int 64 regular  }
	{ gmem int 32 regular {axi_master 0}  }
	{ in_r int 64 regular  }
	{ compressed_data int 64 regular  }
	{ compressed_size int 64 regular  }
	{ gmem_load_out_out int 32 regular {fifo 1}  }
	{ in_out int 64 regular {fifo 1}  }
	{ compressed_data_out int 64 regular {fifo 1}  }
	{ compressed_size_out int 64 regular {fifo 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "chunk_size", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "in_r", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "compressed_data", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "compressed_size", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "gmem_load_out_out", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "in_out", "interface" : "fifo", "bitwidth" : 64, "direction" : "WRITEONLY"} , 
 	{ "Name" : "compressed_data_out", "interface" : "fifo", "bitwidth" : 64, "direction" : "WRITEONLY"} , 
 	{ "Name" : "compressed_size_out", "interface" : "fifo", "bitwidth" : 64, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ chunk_size sc_in sc_lv 64 signal 0 } 
	...
	{ compressed_data sc_in sc_lv 64 signal 3 } 
	{ compressed_size sc_in sc_lv 64 signal 4 } 
	{ gmem_load_out_out_din sc_out sc_lv 32 signal 5 } 
	{ gmem_load_out_out_full_n sc_in sc_logic 1 signal 5 } 
	{ gmem_load_out_out_write sc_out sc_logic 1 signal 5 } 
	{ in_out_din sc_out sc_lv 64 signal 6 } 
	{ in_out_full_n sc_in sc_logic 1 signal 6 } 
	{ in_out_write sc_out sc_logic 1 signal 6 } 
	{ compressed_data_out_din sc_out sc_lv 64 signal 7 } 
	{ compressed_data_out_full_n sc_in sc_logic 1 signal 7 } 
	{ compressed_data_out_write sc_out sc_logic 1 signal 7 } 
	{ compressed_size_out_din sc_out sc_lv 64 signal 8 } 
	{ compressed_size_out_full_n sc_in sc_logic 1 signal 8 } 
	{ compressed_size_out_write sc_out sc_logic 1 signal 8 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "chunk_size", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "chunk_size", "role": "default" }} , 
 	...
 	{ "name": "compressed_data", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "compressed_data", "role": "default" }} , 
 	{ "name": "compressed_size", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "compressed_size", "role": "default" }} , 
 	{ "name": "gmem_load_out_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "gmem_load_out_out", "role": "din" }} , 
 	{ "name": "gmem_load_out_out_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "gmem_load_out_out", "role": "full_n" }} , 
 	{ "name": "gmem_load_out_out_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "gmem_load_out_out", "role": "write" }} , 
 	...
 	{ "name": "compressed_data_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "compressed_data_out", "role": "din" }} , 
 	{ "name": "compressed_data_out_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "compressed_data_out", "role": "full_n" }} , 
 	{ "name": "compressed_data_out_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "compressed_data_out", "role": "write" }} , 
 	{ "name": "compressed_size_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "compressed_size_out", "role": "din" }} , 
 	{ "name": "compressed_size_out_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "compressed_size_out", "role": "full_n" }} , 
 	{ "name": "compressed_size_out_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "compressed_size_out", "role": "write" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "gmem_load_out_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"BlockSignal" : [
			...
			{"Name" : "compressed_data_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "5", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "compressed_data_out_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "compressed_size_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "5", "DependentChanType" : "2",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	chunk_size { ap_none {  { chunk_size in_data 0 64 } } }
	...
	compressed_data { ap_none {  { compressed_data in_data 0 64 } } }
	compressed_size { ap_none {  { compressed_size in_data 0 64 } } }
	gmem_load_out_out { ap_fifo {  { gmem_load_out_out_din fifo_data 1 32 }  { gmem_load_out_out_full_n fifo_status 0 1 }  { gmem_load_out_out_write fifo_update 1 1 } } }
	in_out { ap_fifo {  { in_out_din fifo_data 1 64 }  { in_out_full_n fifo_status 0 1 }  { in_out_write fifo_update 1 1 } } }
	compressed_data_out { ap_fifo {  { compressed_data_out_din fifo_data 1 64 }  { compressed_data_out_full_n fifo_status 0 1 }  { compressed_data_out_write fifo_update 1 1 } } }
	compressed_size_out { ap_fifo {  { compressed_size_out_din fifo_data 1 64 }  { compressed_size_out_full_n fifo_status 0 1 }  { compressed_size_out_write fifo_update 1 1 } } }
}
