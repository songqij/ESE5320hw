...
module lzw_load_input (
        ...
        gmem_load_loc_read,
        gmem_load_loc_out_din,
        gmem_load_loc_out_full_n,
        gmem_load_loc_out_write
);
...
output  [31:0] gmem_load_loc_out_din;
input   gmem_load_loc_out_full_n;
output   gmem_load_loc_out_write;
...
reg   [0:0] icmp_ln133_1_reg_151;
reg    inStream_blk_n;
reg    ap_enable_reg_pp0_iter2;
reg   [0:0] icmp_ln133_1_reg_151_pp0_iter1_reg;
reg    in_r_blk_n;
reg    gmem_load_loc_blk_n;
reg    gmem_load_loc_out_blk_n;
reg   [31:0] i_reg_96;
reg   [31:0] gmem_load_loc_read_reg_130;
wire   [0:0] icmp_ln133_fu_107_p2;
reg   [63:0] aximm1_addr_reg_140;
wire   [31:0] add_ln133_fu_119_p2;
...
wire   [0:0] icmp_ln133_1_fu_125_p2;
reg   [7:0] aximm1_addr_read_reg_155;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state71)) begin
        i_reg_96 <= 32'd0;
    end else if (((icmp_ln133_1_fu_125_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        i_reg_96 <= add_ln133_fu_119_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln133_1_reg_151 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        aximm1_addr_read_reg_155 <= m_axi_aximm1_RDATA;
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln133_fu_107_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if ((icmp_ln133_1_fu_125_p2 == 1'd1)) begin
...
always @ (*) begin
    if (((icmp_ln133_1_reg_151 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
...
always @ (*) begin
    if ((~((ap_done_reg == 1'b1) | (real_start == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        ...
        gmem_load_loc_out_blk_n = 1'b1;
    end
end

always @ (*) begin
    if ((~((ap_done_reg == 1'b1) | (real_start == 1'b0) | (gmem_load_loc_out_full_n == 1'b0) | (gmem_load_loc_empty_n == 1'b0) | (in_r_empty_n == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        gmem_load_loc_out_write = 1'b1;
    end else begin
        gmem_load_loc_out_write = 1'b0;
    end
end
...
always @ (*) begin
    if (((icmp_ln133_1_reg_151_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0))) begin
...
always @ (*) begin
    if (((icmp_ln133_1_reg_151_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        inStream_write = 1'b1;
    end else begin
        inStream_write = 1'b0;
    end
...
always @ (*) begin
    if (((icmp_ln133_1_reg_151 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ap_ST_fsm_state1 : begin
            if ((~((ap_done_reg == 1'b1) | (real_start == 1'b0) | (gmem_load_loc_out_full_n == 1'b0) | (gmem_load_loc_empty_n == 1'b0) | (in_r_empty_n == 1'b0)) & (icmp_ln133_fu_107_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state1))) begin
                ap_NS_fsm = ap_ST_fsm_state75;
            end else if ((~((ap_done_reg == 1'b1) | (real_start == 1'b0) | (gmem_load_loc_out_full_n == 1'b0) | (gmem_load_loc_empty_n == 1'b0) | (in_r_empty_n == 1'b0)) & (icmp_ln133_fu_107_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1))) begin
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((icmp_ln133_1_fu_125_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)) & ~((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((icmp_ln133_1_fu_125_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)) | ((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)))) begin
                ap_NS_fsm = ap_ST_fsm_state75;
            end else begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end
...
assign add_ln133_fu_119_p2 = (i_reg_96 + 32'd1);
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = (((icmp_ln133_1_reg_151_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (inStream_full_n == 1'b0)) | ((icmp_ln133_1_reg_151 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (m_axi_aximm1_RVALID == 1'b0)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((icmp_ln133_1_reg_151_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (inStream_full_n == 1'b0)) | ((icmp_ln133_1_reg_151 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (m_axi_aximm1_RVALID == 1'b0)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((icmp_ln133_1_reg_151_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (inStream_full_n == 1'b0)) | ((icmp_ln133_1_reg_151 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (m_axi_aximm1_RVALID == 1'b0)));
end

always @ (*) begin
    ap_block_state1 = ((ap_done_reg == 1'b1) | (real_start == 1'b0) | (gmem_load_loc_out_full_n == 1'b0) | (gmem_load_loc_empty_n == 1'b0) | (in_r_empty_n == 1'b0));
end

assign ap_block_state72_pp0_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state73_pp0_stage0_iter1 = ((icmp_ln133_1_reg_151 == 1'd0) & (m_axi_aximm1_RVALID == 1'b0));
end

always @ (*) begin
    ap_block_state74_pp0_stage0_iter2 = ((icmp_ln133_1_reg_151_pp0_iter1_reg == 1'd0) & (inStream_full_n == 1'b0));
end
...
assign gmem_load_loc_out_din = gmem_load_loc_dout;

assign icmp_ln133_1_fu_125_p2 = ((i_reg_96 == gmem_load_loc_read_reg_130) ? 1'b1 : 1'b0);

assign icmp_ln133_fu_107_p2 = ((gmem_load_loc_dout == 32'd0) ? 1'b1 : 1'b0);

assign inStream_din = aximm1_addr_read_reg_155;

assign m_axi_aximm1_ARADDR = aximm1_addr_reg_140;
...
assign m_axi_aximm1_ARLEN = gmem_load_loc_read_reg_130;
