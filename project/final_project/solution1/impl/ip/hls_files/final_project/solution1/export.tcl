...
set_top lzw
add_files Server/p3/lzw.h
add_files Server/p3/lzw.cpp
add_files -tb Server/p3/testbench.cpp -cflags "-Wno-unknown-pragmas" -csimflags "-Wno-unknown-pragmas"
...
config_export -format xo -output /home1/s/songqij/ese532_code/project/Server/p3/lzw.xo -rtl verilog
